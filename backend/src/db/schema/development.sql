...
INSERT INTO EVENTUSER (user_id, event_id) VALUES
  ...
  (6, 3),  -- User with ID 6 is signed up for event with ID 3
  (7, 4),  -- User with ID 7 is signed up for event with ID 4
  (8, 4),  -- User with ID 8 is signed up for event with ID 4
  (9, 5),  -- User with ID 9 is signed up for event with ID 5
  (10, 5); -- User with ID 10 is signed up for event with ID 5
