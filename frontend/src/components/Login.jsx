...
function Login({ setLoggedIn, loggedIn }) {
  ...
  return (<>
    <div className="pt-40 flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 animate__animated animate__bounceInDown">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6">
          ...
          <div>
            ...
            {/* <button
              type="button"
              className="flex w-full justify-center rounded-md bg-sky-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              onClick={handleLogin}
            >
              Sign in
            </button> */}
